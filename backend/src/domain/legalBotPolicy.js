...
7. Se o assunto ainda nao foi informado, pergunte de forma aberta como o escritorio pode ajudar, sem apresentar menu.
8. Nao repita saudacao, apresentacao ou pergunta ja respondida no historico.
9. Use texto simples de WhatsApp, sem titulos, sem listas extensas e sem marcacao com dois asteriscos.
10. Inclua ao final, de forma invisivel ao cliente, uma unica rota: [[ROUTE: FINANCEIRO]] para revisao bancaria, financiamento, juros, cobrancas ou dividas; [[ROUTE: ATENDIMENTO]] para os demais assuntos.
...
${subjectProvided && !nameConfirmed
    ...
    : nameConfirmed
      ...
      : '- Faca somente uma pergunta aberta para o cliente informar como o escritorio pode ajudar.'}
`;
}
